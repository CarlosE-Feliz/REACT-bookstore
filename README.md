...
### Book store is a project created with React and Redux, on this project we will imporve what we learn the last week about Redux, with this app you can Add a book that you like (or want to buy) and I keep the info for you until you delete the book from the list!
## Built With
...
**Step 3 - type 'git clone https://github.com/xJokeer/bookstore.git'**<br>
...
Feel free to check the [issues page](https://github.com/xJokeer/bookstore/issues).
